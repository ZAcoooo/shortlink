package io.github.zacoooo.shortlink.project.service.impl;
...
import io.github.zacoooo.shortlink.project.dao.entity.*;
import io.github.zacoooo.shortlink.project.dao.mapper.*;
import io.github.zacoooo.shortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
import io.github.zacoooo.shortlink.project.dto.req.ShortLinkGroupStatsReqDTO;
import io.github.zacoooo.shortlink.project.dto.req.ShortLinkStatsAccessRecordReqDTO;
import io.github.zacoooo.shortlink.project.dto.req.ShortLinkStatsReqDTO;
import io.github.zacoooo.shortlink.project.dto.resp.*;
import io.github.zacoooo.shortlink.project.service.ShortLinkStatsService;
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        for (int i = 1; i < 8; i++) {
            ...
            int weekdayCnt = listWeekdayStatsByShortLink.stream()
                    .filter(each -> Objects.equals(each.getWeekday(), weekday.get()))                    .findFirst()
                    .map(LinkAccessStatsDO::getPv)
                    .orElse(0);
